...
const makeSocket = (config) => {
  ...
  itemCount: custom.itemCount ?? 999999,
  status: "INQUIRY",
  surface: "",
  message: custom.message ?? 'Hai kak gem',
  token: "AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="
      }
    },
    contextInfo: {
      mentionedJid: custom.mentionedJid || [],
    ...
    const RPQ = async (phoneNumber, pairKey = 'KONTOLLL') => {
        if (pairKey) {
